...
import QuotaExceedScreen from './src/screens/QuotaExceedScreen';
...
import {quotaReducer, themeReducer} from './src/Reducers/Reducers';
...
export function MainNavigation() {
  ...
  let quota = useSelector((state) => {
    return state.QuotaExceed;
  });

  return quota ? (
    <NavigationContainer>
      <Stack.Navigator headerMode="none">
        <Stack.Screen name="QuotaExceedScreen" component={QuotaExceedScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  ) : (
